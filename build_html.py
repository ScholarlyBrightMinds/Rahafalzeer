...
# tldrs.json. Run against the title (lower-cased). Multiple matches accumulate.
_TOPIC_HEURISTICS = [
    ("repurpose", ["repurposing", "repositioning", "repurposed"]),
    ("oncology",  ["cancer", "tumor", "tumour", "oncology", "endothelin",
                   "antiamyloid", "alzheimer"]),
    ("thesis",    ["aprocitentan", "msc thesis"]),
    ("review",    ["review", "introduction to", "insights into", "barriers",
                   "perspectives", "advancements and challenges"]),
    ("pharm",     ["pharmacy", "pharmacist", "rosmarinus", "essential oil",
                   "covid", "allergic", "osce", "online learning",
                   "medication disposal", "breast cancer awareness",
